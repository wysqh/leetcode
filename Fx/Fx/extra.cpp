...
//#define LEFT(i) (2*i)			//获取左节点索引
//#define RIGHT(i) (2*i+1)		//获取右节点索引
//
//public:
//	Solution() {}
...
//		return;
//
//	while (i >= 0 && i <= PAR(length) && vals[i] < max(vals[LEFT(i)], vals[RIGHT(i)]))
//	{
//		int maxindex = vals[LEFT(i)] > vals[RIGHT(i)] ? LEFT(i) : RIGHT(i);
//		int tmp = vals[i];
